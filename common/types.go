...
import (
	...
	"github.com/dacchain/dacapp/crypto/sha3"
)
...
func Report(extra ...interface{}) {
	fmt.Fprintln(os.Stderr, "You've encountered a sought after, hard to reproduce bug. Please report this to the developers <3 https://github.com/dacchain/dacapp/issues")
