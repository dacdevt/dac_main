...
import (
	...
	"github.com/dacchain/dacapp/utils/jsre"
	"github.com/dacchain/dacapp/utils/web3ext"
...
type Config struct {
	...
	Client   *rpc.Client  // RPC client to execute dacChain requests through
...
func (c *Console) Welcome() {
	...
	fmt.Fprintf(c.printer, "Welcome to the dacChain JavaScript console!\n\n")
	c.jsre.Run(`
		console.log("instance: " + web3.version.node);
		console.log("coinbase: " + dac.coinbase);
		console.log("at block: " + dac.blockNumber + " (" + new Date(1000 * dac.getBlock(eth.blockNumber).timestamp) + ")");
