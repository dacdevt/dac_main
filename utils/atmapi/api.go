...
// PublicdacAPI provides an API to access dacChain related information.
// It offers only methods that operate on public data that is freely available to anyone.
type PublicdacAPI struct {
	b Backend
}

// NewPublicdacAPI creates a new dacChain protocol API.
func NewPublicdacAPI(b Backend) *PublicdacAPI {
	return &PublicdacAPI{b}
}

// ProtocolVersion returns the current dacChain protocol version this node supports
func (s *PublicdacAPI) ProtocolVersion() uint {
	return uint(s.b.ProtocolVersion())
}

// GasPrice returns a suggestion for a gas price.
func (s *PublicdacAPI) GasPrice(ctx context.Context) (*big.Int, error) {
	return s.b.SuggestPrice(ctx)
}

// PublicBlockChainAPI provides an API to access the dacChain blockchain.
// It offers only methods that operate on public data that is freely available to anyone.
type PublicBlockChainAPI struct {
	b Backend
}

// NewPublicBlockChainAPI creates a new dacChain blockchain API.
...
// PublicDebugAPI is the collection of dacChain APIs exposed over the public
// debugging endpoint.
...
// of the dacChain service.
func NewPublicDebugAPI(b Backend) *PublicDebugAPI {
	return &PublicDebugAPI{b: b}
}

// PrivateDebugAPI is the collection of dacChain APIs exposed over the private
// debugging endpoint.
